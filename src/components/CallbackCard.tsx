  ...
  return (
    <div className="fixed inset-0 z-[500] flex items-center justify-center bg-black/60 backdrop-blur-sm px-5">
      <div className="relative w-full max-w-3xl rounded-2xl overflow-hidden bg-white shadow-xl">
        ...
        <div className="relative flex flex-col md:flex-row bg-[#077A7D] text-white p-6 md:p-8 gap-6">
        ...
        <div className="bg-white px-6 py-5 rounded-b-2xl shadow-inner hidden md:block ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="group relative  rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-sky-50 p-6 shadow-sm hover:shadow-xl transition-all duration-300">
              <div className="absolute -top-4 -left-4 bg-sky-100 text-[#077A7D] px-3 py-1 rounded border text-xs font-semibold shadow-sm">
                ACE CMS
              </div>
              <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-[#077A7D] transition-colors duration-300">
                {t('feature1')}
              </h3>
              ...
              <Link
                ...
                className=" text-sm font-semibold text-[#077A7D] transition-colors flex gap-1"
              >
            ...
            <div className="group relative rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-sky-50 p-6 shadow-sm hover:shadow-xl transition-all duration-300">
              <div className="absolute -top-4 -left-4 bg-sky-100 text-[#077A7D] px-3 py-1 border rounded  text-xs font-semibold shadow-sm">
                ACE CRM
              </div>
              <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-[#077A7D] transition-colors duration-300">
                {t('feature2')}
              ...
              <Link
                ...
                className="flex text-sm font-semibold text-[#077A7D] transition-colors gap-1"
              >
                {t('LearnMore')} <FaArrowRightLong className='mt-1' />
              </Link>
            </div>
