    ...
    <div className="shadow-sm shadow-gray-200  relative z-[300] ">
      <nav className="container mx-auto hidden md:flex items-center justify-between md:pt-2 pb-2  px-4 md:px-0  relative  z-[300]">
        <div className="flex">
            ...
            <Link href="https://acesoft.in/" className=" font-bold text-[#2b2d42] flex gap-1">
              <Image
                src={logo}
                alt="logo"
                width={100}
          ...
          <div className="hidden md:flex items-center space-x-4 ml-10">
            ...
            <Link
              ...
              className="flex items-center text-[#2b2d42]  border border-white   text-sm font-semibold relative px-4 py-2 rounded-full transition-all duration-300 ease-in-out  hover:scale-105"
            >
              {t('AllProducts')}
            </Link>
          </div>
                ...
                .map((lang) => (
                  <li key={lang.code}>
                    <button
                      ...
                      className="flex items-center gap-2 px-1 py-1 text-sm text-gray-800 hover:bg-blue-50 hover:text-[#155E95] transition rounded"
                    >
