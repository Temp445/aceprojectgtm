...
if (!CONVERSION_LABEL) {
  console.error(
    "❌ Google Conversion Label missing. Set NEXT_PUBLIC_GA_ENQ_CONVERSION_LABEL in .env."
  );
}
...
if (!LI_ENQ_CONVERSION_LABEL) {
  console.error(
    "❌ LinkedIn Conversion Label missing. Set NEXT_PUBLIC_LI_ENQ_CONVERSION_ID in .env."
  );
}
      ...
      <div>
        ...
        <div className="flex items-center justify-center pb-24  md:py-16 px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10 items-start w-full max-w-6xl">
            <div className="flex flex-col justify-center space-y-6 lg:mt-3">
              <h1
                className={`text-2xl md:text-3xl ${Text}  font-bold text-black flex flex-row gap-4`}
              >
                {t1("contact")}{" "}
                <span>
                  <span className="rotate-6">
                    <ClipboardPenLine className="w-10 h-10 animate-pulse rotate-6" />
                  </span>
                </span>
              </h1>
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <textarea
                        ...
                        className="text-sm md:text-sm border p-2 mt-1 rounded w-full h-24"
                      />
                    </div>
